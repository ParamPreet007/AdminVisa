...
import { ModalLogout } from "../../assets/Images";
...
export default function VisaLandingPage() {
  ...
  useEffect(() => {
    getStatusData();
  }, [showStatusModal?.open, openModal]);
  ...
  const countryDetails = {
    USA: {
      ...
      flag: "🇺🇸",
      description:
        "The land of opportunities with world-class education and career prospects.",
      visaTypes: [
        {
          type: "H-1B Work Visa",
          duration: "3 years",
    ...
    Canada: {
      ...
      flag: "🇨🇦",
      description:
        "A welcoming nation known for its quality of life and immigration-friendly policies.",
      visaTypes: [
        {
          type: "Express Entry",
          duration: "Permanent",
    ...
    Australia: {
      ...
      flag: "🇦🇺",
      description:
        "A dynamic country offering excellent work-life balance and world-class education.",
      visaTypes: [
        {
    ...
    UK: {
      ...
      flag: "🇬🇧",
      description:
        "Historic nation with prestigious universities and rich cultural heritage.",
      visaTypes: [
        {
    ...
    Germany: {
      ...
      flag: "🇩🇪",
      description:
        "Europe's economic powerhouse with excellent opportunities for skilled professionals.",
      visaTypes: [
        {
          type: "EU Blue Card",
          duration: "4 years",
    ...
    "New Zealand": {
      ...
      flag: "🇳🇿",
      description:
        "Beautiful island nation known for its natural beauty and friendly people.",
      visaTypes: [
        {
  ...
  const countries = [
    {
      name: "USA",
      flag: "🇺🇸",
      visaTypes: ["Work", "Study", "Tourist"],
      color: "from-red-400 to-blue-600",
    },
    {
      name: "Canada",
      flag: "🇨🇦",
      visaTypes: ["Express Entry", "Study", "Visit"],
    ...
    },
    {
      name: "UK",
      flag: "🇬🇧",
      visaTypes: ["Work", "Study", "Visit"],
      color: "from-blue-600 to-red-500",
    },
    {
      name: "Germany",
      flag: "🇩🇪",
      visaTypes: ["Work", "Study", "Business"],
      color: "from-yellow-400 to-red-500",
    },
    {
      name: "New Zealand",
      flag: "🇳🇿",
      visaTypes: ["Skilled", "Study", "Work"],
  ...
  const services = [
    {
      ...
      description:
        "Expert assistance for visa applications to 50+ countries worldwide",
      features: [
    ...
    },
    {
      ...
      description:
        "Personalized guidance from certified immigration consultants",
    ...
    },
    {
      ...
      description:
        "98% success rate with money-back guarantee on visa approvals",
    ...
    <>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 overflow-hidden">
        ...
        <div className="fixed inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-40 right-20 text-3xl animate-spin-slow">
            🌍
          </div>
          <div className="absolute bottom-32 left-1/4 text-2xl animate-pulse">
            📋
          </div>
          <div className="absolute bottom-20 right-1/3 text-3xl animate-bounce">
            🎯
          </div>
          <div className="absolute top-1/2 left-1/2 text-2xl animate-wiggle">
            📍
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-zoom-in">
                ...
                <br />
                <span className="text-gray-800 animate-slide-up-delayed">
                  Global Opportunities
                </span>
              </h1>

              <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto animate-fade-in-up-slow">
                Expert visa consultation services for work, study, and
                immigration to 50+ countries worldwide. Turn your dreams into
                reality with our proven success rate.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 animate-slide-up-stagger"></div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
                {stats.map((stat, index) => (
                  ...
                  >
                    ...
                    <div className="text-gray-600 mt-2 animate-fade-in-up">
                      {stat.label}
                    </div>
                  </div>
                ))}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16 animate-fade-in-up">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto animate-slide-in-right">
                We provide visa services for the world's most sought-after
                destinations
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16 animate-fade-in-up">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto animate-fade-in-delayed">
                Comprehensive visa and immigration services tailored to your
                needs
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {services.map((service, index) => (
                ...
                >
                  ...
                  <h3 className="text-2xl font-bold text-gray-800 mb-4 animate-slide-in-left">
                    {service.title}
                  </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {[
                ...
                >
                  ...
                  <div className="text-3xl font-bold text-blue-600 mb-2 animate-number-appear">
                    {process.step}
                  </div>
                  <h3 className="text-xl font-bold text-gray-800 mb-2 animate-slide-in">
                    {process.title}
                  </h3>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16 animate-fade-in-up">
              <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4 animate-text-glow">
                Success Stories
              </h2>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto animate-fade-in-delayed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {testimonials.map((testimonial, index) => (
                <div
                  ...
                  style={{ animationDelay: `${index * 200}ms` }}
                >
                  <div className="text-6xl mb-4 animate-bounce-gentle group-hover:animate-wave">
                    {testimonial.avatar}
                  </div>
                  ...
                  <p className="text-gray-700 mb-6 italic animate-text-type">
                    "{testimonial.text}"
                  </p>
                  <div>
                    <div className="font-bold text-gray-800 animate-slide-in-left">
                      {testimonial.name}
                    </div>
                    <div className="text-blue-600 animate-slide-in-right">
                      {testimonial.country}
                    </div>
                  </div>
                </div>
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 animate-gradient-shift">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-blue-100 mb-8 animate-fade-in-up">
              Join thousands of successful applicants who trusted us with their
              visa applications
            </p>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                  ...
                  <div className="bg-yellow-50 p-4 rounded-lg text-center">
                    <div className="text-2xl font-bold text-yellow-600">
                      {selectedCountry.popularCities.length}
                    </div>
        ...
        <style jsx>{`
          ...
          .animate-fade-in-up-slow {
            animation: fade-in-up-slow 1s ease-out 0.8s both;
          }
          .animate-slide-up-stagger {
            animation: slide-up-stagger 1s ease-out 1s both;
          }
          ...
          .animate-service-card {
            animation: service-card 1s ease-out both;
          }
          .animate-icon-bounce {
          ...
          .animate-process-step {
            animation: process-step 0.8s ease-out both;
          }
          .animate-step-circle {
            animation: step-circle 0.8s ease-out;
          }
          .animate-pulse-ring:hover {
            animation: pulse-ring 1s ease-out;
          }
          .animate-number-appear {
            animation: number-appear 0.6s ease-out;
          }
          .animate-slide-in {
          ...
          .animate-star-twinkle {
            animation: star-twinkle 1s ease-in-out infinite both;
          }
          .animate-text-type {
            animation: text-type 2s ease-out;
          }
          ...
          .animate-cta-buttons {
            animation: cta-buttons 1s ease-out;
          }
          .animate-button-pulse {
            animation: button-pulse 2s ease-in-out infinite;
          }
          .animate-button-glow-white {
            animation: button-glow-white 2s ease-in-out infinite;
          }
          .animate-slide-up-footer {
            animation: slide-up-footer 1s ease-out;
          }
          .animate-pulse-slow {
      ...
      <StatusCheck
        res={res}
        open={showStatusModal?.open}
        onCancel={() => setShowStatusModal({ ...showStatusModal, open: false })}
      />
      <Modal
      footer={false}
        open={logoutOpen}
      ...
      >
        <div className="flex flex-col items-center gap-4">
          <img src={ModalLogout} alt={ModalLogout} />
          <div className="text-[#605F5F] text-base w-4/5 text-center text-sm">
            Are you sure you want to Logout ?
          </div>
          <div className="flex gap-2">
            <button
              className={`text-[#605F5F] border text-sm py-1 w-24 rounded 
                 cursor-pointer
              `}
              onClick={
                ()=>{
            ...
            <button
              className={`bg-[var(--primary)] text-white text-sm py-1 w-24 rounded flex items-center gap-2 justify-center 
                cursor-pointer
              `}
              onClick={logoutAdmin}
            >
